		...
		<>
			<div className='main' id='top'>
				...
				<div className='how-it-works'>
					...
					<img src='https://i.ibb.co/2F05Sf4/bulb.png' className='vector' alt='early prediction'/>
						...
						<div className='content-container'>
						<img src='https://i.ibb.co/9b8gFGv/time.png' className='vector time' alt='save time'/>
						...
						<div className='content-container'>
						<img src='https://i.ibb.co/bbwJBXH/storage.png' className='vector' alt='data storage'/>
